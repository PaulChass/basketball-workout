export const drills = [
  { 
    title: 'Pound Dribble', 
    duration: 0.5, 
    description: 'Amélioration de la force et du contrôle de votre dribble.',
    videoUrl: 'https://balldontlie.fr/Dribble.mp4?v=1.0',
    instructions: 'Dribblez la balle aussi fort que possible en alternant les mains toutes les 10 dribbles.',
    tips: [
      'Gardez votre dos droit et vos genoux légèrement fléchis.',
      'Utilisez vos doigts pour contrôler la balle, pas votre paume.',
      'Regardez droit devant vous, pas la balle.'
    ]
  },
  { 
    title: 'Crossover', 
    ...
    tips: [
      ...
      'Utilisez un mouvement rapide et fluide pour le crossover.',
      'Dribblez plus ou moins haut pour changer de rythme.'
    ]
  },
  { 
    ...
    tips: [
      'Gardez vos pieds en mouvement pour rester équilibré.',
      'Utilisez vos poignets pour un meilleur contrôle de la balle.',
      'Pratiquez à différentes vitesses pour améliorer votre réactivité.'
    ]
  },
  { 
    ...
    tips: [
      ...
      'Concentrez-vous sur le contrôle de la balle pour éviter les pertes, pas sur la vitesse.'
    ]
  },
  { 
    title: 'Derrière le dos', 
    duration: 0.5, 
    description: 'Amélioration de votre capacité à protéger la balle des défenseurs et aux changements de direction.',
    videoUrl: 'https://balldontlie.fr/derriereLeDos.mp4?v=1.0',
    instructions: 'Dribblez la balle derrière votre dos en changeant de main à chaque fois. Changez de diagonale tous les 10 dribbles.',
    tips: [
      'Gardez votre dos droit et vos genoux légèrement fléchis.',
